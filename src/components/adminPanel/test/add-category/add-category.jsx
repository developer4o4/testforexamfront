...
const AddCategory = ({ isStatus, setIsStatus, initialData = null }) => {
    ...
    return (
        <div className="add-category-container">
            <div className={`add-category-name-shape ${isStatus ? 'active' : ''}`}></div>
            <div className={`add-category-content ${isStatus ? 'active' : ''}`}>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="input-row">
                            ...
                            <input
                                ...
                                placeholder="Bo'lim nomini kiriting (Misol uchun: 1-sinflar bo'limi)"
                            />
